...
class TestDiscordOAuthService:
    ...
    def test_get_authorization_url_success(self):
        ...
        original = discord_oauth.DISCORD_CLIENT_ID
        discord_oauth.DISCORD_CLIENT_ID = "test-client-id-12345"
...
class TestDiscordOAuthTokenExchange:
    ...
    async def test_exchange_code_not_configured(self):
        ...
        orig_secret = discord_oauth.DISCORD_CLIENT_SECRET
        discord_oauth.DISCORD_CLIENT_ID = ""
        ...
        try:
            ...
            discord_oauth.DISCORD_CLIENT_SECRET = orig_secret
    ...
    async def test_exchange_code_success(self):
        ...
        orig_id = discord_oauth.DISCORD_CLIENT_ID
        orig_secret = discord_oauth.DISCORD_CLIENT_SECRET
        discord_oauth.DISCORD_CLIENT_ID = "test-client-id"
        discord_oauth.DISCORD_CLIENT_SECRET = "test-secret"
