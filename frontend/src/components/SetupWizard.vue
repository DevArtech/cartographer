	...
	<div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
		<div class="w-full max-w-md">
			...
			<div class="text-center mb-8">
				...
				<h1 class="text-3xl font-bold text-white tracking-tight">Cartographer</h1>
				<p class="text-slate-400 mt-2">Network Mapping & Monitoring</p>
			</div>

			<!-- Setup Card -->
			<div class="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl p-8">
				<div class="text-center mb-6">
					<h2 class="text-xl font-semibold text-white">Welcome! Let's get started</h2>
				...
				<form @submit.prevent="onSubmit" class="space-y-5">
					...
					<div>
						...
						<div class="relative">
							<input
								...
								class="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition pr-12"
								placeholder="••••••••"
								:disabled="isSubmitting"
							/>
							<button
					...
					<!-- Error Message -->
					<div v-if="errorMessage" class="p-3 bg-red-900/30 border border-red-500/50 rounded-lg">
					...
					<button
						...
						class="w-full py-3 px-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
					>
