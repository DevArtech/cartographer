<template>
	<div class="space-y-4">
		...
		<div class="space-y-3" v-if="anomalyStats">
			<h3 class="flex items-center gap-1.5 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
			...
			<div class="p-3 bg-slate-50 dark:bg-slate-800/40 rounded-lg border border-slate-200/80 dark:border-slate-700/50">
				<div class="grid grid-cols-3 gap-3">
					<div>
						<p class="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider">Devices Tracked</p>
						<p class="text-lg font-semibold text-slate-800 dark:text-slate-100">{{ anomalyStats.devices_tracked || 0 }}</p>
					</div>
					<div>
						<p class="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider">Anomalies (24h)</p>
						<p class="text-lg font-semibold text-slate-800 dark:text-slate-100">{{ anomalyStats.anomalies_detected_24h || 0 }}</p>
					</div>
					<div>
