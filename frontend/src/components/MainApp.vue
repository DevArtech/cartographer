<template>
	...
	<div v-if="!isNetworkMode && authLoading" class="h-screen flex items-center justify-center bg-white dark:bg-slate-950 relative overflow-hidden transition-colors">
		...
		<div class="relative text-center">
			...
			<p class="text-sm text-slate-500 dark:text-slate-400 mt-3">Loading your network...</p>
		</div>
	</div>
