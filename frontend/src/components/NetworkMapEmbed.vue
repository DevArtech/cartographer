	...
	<div class="w-full h-full relative">
		...
		<div class="absolute inset-0 overflow-hidden pointer-events-none">
			...
			<div 
				...
				style="background: radial-gradient(ellipse 100% 80% at 50% 30%, rgba(56, 189, 248, 0.08) 0%, rgba(56, 189, 248, 0.02) 35%, transparent 55%)"
			></div>
			<!-- Bottom corner accent with smoother falloff -->
			<div 
				class="absolute inset-0"
				:class="isDark ? 'opacity-15' : 'opacity-30'"
				style="background: radial-gradient(ellipse 60% 50% at 90% 90%, rgba(99, 102, 241, 0.06) 0%, rgba(99, 102, 241, 0.015) 35%, transparent 55%)"
			></div>
		</div>
