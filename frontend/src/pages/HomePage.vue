<template>
	...
	<div v-if="authLoading" class="h-screen flex items-center justify-center bg-white dark:bg-slate-950 relative overflow-hidden transition-colors">
		...
		<div class="relative text-center">
			<!-- App Logo -->
			<div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#0fb685] to-[#0994ae] rounded-2xl shadow-lg shadow-[#0fb685]/30 mb-6">
			...
			<!-- App Name -->
			<h1 class="text-2xl font-bold text-slate-900 dark:text-white tracking-tight mb-2">Cartographer</h1>
		...
		<header class="fixed top-0 left-0 right-0 z-50 flex items-center h-14 px-4 border-b border-slate-200 dark:border-slate-800/80 bg-white/95 dark:bg-slate-950/95 backdrop-blur-lg">
			...
			<div class="flex items-center gap-3 mr-6">
				<router-link to="/" class="flex items-center gap-3">
					<div class="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-[#0fb685] to-[#0994ae] shadow-sm">
			...
			<div class="max-w-6xl mx-auto">
				...
				<div v-if="networksLoading" class="flex flex-col items-center justify-center py-16">
					<div class="flex gap-1.5 mb-3">
						<span class="w-2.5 h-2.5 rounded-full bg-cyan-500 animate-bounce" style="animation-delay: 0ms"></span>
						<span class="w-2.5 h-2.5 rounded-full bg-cyan-500 animate-bounce" style="animation-delay: 150ms"></span>
						<span class="w-2.5 h-2.5 rounded-full bg-cyan-500 animate-bounce" style="animation-delay: 300ms"></span>
					</div>
