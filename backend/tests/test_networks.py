...
from app.models.network import Network, NetworkPermission, PermissionRole, NetworkNotificationSettings
...
class TestListNetworks:
    ...
    async def test_list_networks_as_metrics_service(self, metrics_service_user, mock_db, sample_network):
...
class TestUpdateNetworkNotificationSettings:
    ...
    async def test_update_settings_success(self, owner_user, mock_db, sample_network):
        ...
        from app.schemas import NetworkNotificationSettingsCreate, EmailConfigCreate, DiscordConfigCreate, NotificationPreferencesCreate
